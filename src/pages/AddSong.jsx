        ...
        <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600'>
            ...
            <div className='flex flex-col gap-2.5'>
                ...
                <div className='bg-transparent  border-2 border-gray-400 hover:border-green-600 p-2.5 w-[max(40vw,250px)]'>
                    ...
                    value={name} type="text" placeholder='Type Here' required />
                </div>
            </div>
            <div className='flex flex-col gap-2.5'>
                <p>Song sescription</p>
                <div className='border-2 border-gray-400 hover:border-green-600 p-2.5 w-[max(40vw,250px)]'>
                    <input onChange={(e)=>setDesc(e.target.value)}  
                    value={desc} type="text" placeholder='Type Here' required />
                </div>
            </div>
            <div className='flex flex-col gap-2.5'>
                <p>Album</p>
